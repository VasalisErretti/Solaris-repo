...
void MenuScreen(float deltaTasSeconds)
{
	...
	Fx[0].SetPosition(powChannel, drumPos, drumVel);
...
void InitializeSounds() {
	...
	powerup[8].Load(_strdup((SoundPath + "Soundeffects//Health_up.wav").c_str()), TRUE, FALSE);//Health up
...
void InitializeObjects()
{
	...
	Objects[0].setTexture(ilutGLLoadImage(_strdup((ImagePath + "Ground0.3.png").c_str())));
	...
	Enemies[0].setTexture(ilutGLLoadImage(_strdup((ImagePath + "Enemy0.3.png").c_str())));
