...
int NumberOfEnemies = 12; GameObject Enemies[12]; //BALLS
	...
	if (inMenu) {
		...
		case '3': 
			Specials[3].Viewable = true; Specials[3].setPosition(glm::vec3(0.0f, 20.0f, 0.0f));//Health up
				  break;
		case '4': 
			Specials[4].Viewable = true; Specials[4].setPosition(glm::vec3(0.0f, 20.0f, 0.0f));//Box
			break;
		}
	}
	else if (inOptions) {
...
void LoadAllSounds() {
	...
	if (DoesFileExists("..//Assets//Media//Soundeffects")) {
		SoundPath = "..//Assets//Media//Soundeffects//";
	}
	else if (DoesFileExists("Assets//Media//Soundeffects")) {
		SoundPath = "Assets//Media//Soundeffects//";
	}
